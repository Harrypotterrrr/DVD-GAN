...
class SpatialDiscriminator(nn.Module):
    ...
    def __init__(self, chn=128, n_class=4):
        ...
        self.conv1 = GBlock(2*chn, 4*chn, bn=False, downsample=True)
        self.attn = SelfAttention(4*chn)
        self.conv2 = nn.Sequential(
            GBlock(4*chn, 8*chn, bn=False, downsample=True),
            GBlock(8*chn, 16*chn, bn=False, downsample=True),
            GBlock(16*chn, 16*chn, bn=False, downsample=True)
        )
